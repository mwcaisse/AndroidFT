...
CREATE TABLE USER_AUTH_TOKEN (
	UAT_ID BIGINT NOT NULL AUTO_INCREMENT,
	UAT_USER_ID BIGINT NOT NULL,
	UAT_TOKEN VARCHAR(50) UNIQUE NOT NULL,
	UAT_DEV_UID VARCHAR(50) NOT NULL,
	UAT_ACTIVE BIT NOT NULL DEFAULT 1,
	UAT_LAST_LOGIN TIMESTAMP NULL DEFAULT NULL,
	UAT_LAST_LOGIN_ADDR VARCHAR(50) NULL DEFAULT NULL,
	UAT_EXP_DATE TIMESTAMP NULL DEFAULT NULL,
	PRIMARY KEY (UAT_ID),
	FOREIGN KEY (UAT_USER_ID) REFERENCES USER(USER_ID)
);	
...
CREATE TABLE DEVICE (
	...
	DEV_UID VARCHAR(25) UNIQUE NOT NULL,
...
CREATE TABLE DEVICE_IMAGE (
	DEV_IMG_ID BIGINT NOT NULL AUTO_INCREMENT,
	DEV_ID BIGINT UNIQUE NOT NULL,
	DEV_IMG_CONT MEDIUMBLOB,
	DEV_IMG_SIZE BIGINT NOT NULL,
	PRIMARY KEY (DEV_IMG_ID),
