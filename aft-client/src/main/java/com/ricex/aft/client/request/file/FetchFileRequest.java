...
public class FetchFileRequest extends AbstractRequest<File> {
	...
	public FetchFileRequest(long fileId, RequestListener<File> listener) {
		super(listener);
		this.fileId = fileId;
	}
	...
	protected void constructServerRequest() {
		serverRequest = Unirest.get(baseServiceUrl + "file/" + fileId);
	}
