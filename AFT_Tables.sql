...
CREATE TABLE USER (
	...
	USER_EXP_DATE TIMESTAMP DEFAULT NULL,
	USER_PASSWORD_EXP_DATE TIMESTAMP DEFAULT NULL,	
	PRIMARY KEY (USER_ID)
...
INSERT INTO USER (USER_USERNAME, USER_PASSWORD, USER_ACTIVE)
VALUES		  ('mitchell','password1', 1),
			  ('admin','password1', 1);
